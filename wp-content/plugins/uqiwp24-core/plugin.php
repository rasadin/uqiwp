 ...
 * @since           1.0.0
 * @package         uqiwp24 Core
 * 
 * Plugin Name:     uqiwp24 Core
 * Plugin URI:      https://www.aptc.com.au/
 * Description:     Core plguin for the uqiwp24
 * Version:         1.0.0 
 * Author:          Rasadin
...
function batside_elementor_core_scripts_styles() {
    ...
    wp_enqueue_style('uqiwp24-public', plugins_url('/assets/css/public.css', __FILE__), '', rand());
    wp_enqueue_script('uqiwp24-public', plugins_url('/assets/js/public.js', __FILE__), array('jquery'), rand(), true);
    ...
    wp_localize_script('uqiwp24-public', 'public_localizer', $options);
}
