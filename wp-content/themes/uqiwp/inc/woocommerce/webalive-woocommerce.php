...
if( !class_exists( 'uqiwp_WooCommerce' ) ) :

    /**
     * The uqiwp WooCommerce Integration Class
     */
    class uqiwp_WooCommerce {
        ...
        /**
         * uqiwp WooCommerce Scripts
         * 
         * @since 1.0.0
         */
        public function woocommerce_scripts() {
		    wp_enqueue_style( 'uqiwp-woo-style', get_template_directory_uri() . '/woocommerce.css' );  
        }
		...
		public function related_products_args( $args ) {
			$args = apply_filters( 'uqiwp_related_products_args', array(
				'posts_per_page' => 3,
				'columns'        => 3,
			) );
