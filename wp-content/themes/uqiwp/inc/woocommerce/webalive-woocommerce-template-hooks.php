...
if( ! class_exists( 'uqiwp_WooCommerce_Hooks' ) ) :

    class uqiwp_WooCommerce_Hooks {
        ...
        /**
         * uqiwp WooCommerce Theme Support
         */
...
return new uqiwp_WooCommerce_Hooks();
